...
public class SucaiOrderView extends SucaiOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 订单类型的值
		*/
		private String sucaiOrderValue;
		/**
		* 支付类型的值
		*/
		private String sucaiOrderPaymentValue;
	...
	public SucaiOrderView() {

	}

	public SucaiOrderView(SucaiOrderEntity sucaiOrderEntity) {
		try {
			BeanUtils.copyProperties(this, sucaiOrderEntity);
			...
			* 获取： 订单类型的值
			*/
			public String getSucaiOrderValue() {
				return sucaiOrderValue;
			}
			/**
			* 设置： 订单类型的值
			*/
			public void setSucaiOrderValue(String sucaiOrderValue) {
				this.sucaiOrderValue = sucaiOrderValue;
			}
			/**
			* 获取： 支付类型的值
			*/
			public String getSucaiOrderPaymentValue() {
				return sucaiOrderPaymentValue;
			}
			/**
			* 设置： 支付类型的值
			*/
			public void setSucaiOrderPaymentValue(String sucaiOrderPaymentValue) {
				this.sucaiOrderPaymentValue = sucaiOrderPaymentValue;
			}
